...
@Table(name = "offline_user2todo")
public class DBOfflineUser2Todo {
    ...
    public DBOfflineUser2Todo() {
    }

    public DBOfflineUser2Todo(String objectId, int userId, int todoId, boolean swt) {
    ...
    public static int save(AVObject user2todo) {
        DBOfflineUser2Todo dbUser2Todo = new DBOfflineUser2Todo();
    ...
    public static AVObject getUser2todo(DBOfflineUser2Todo dbUser2Todo) {
    ...
    public static void delete(DBOfflineUser2Todo dbUser2Todo) {
